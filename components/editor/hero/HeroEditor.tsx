				...
				<div className="w-full flex-col flex gap-4">
					...
					<div className="w-full flex gap-2">
						<div className="flex flex-col mt-2 gap-2 w-full">
							<Label htmlFor="cta-padding-slider">Padding Horizontal</Label>
							<Slider
								min={1}
								max={40}
								step={1}
								value={[(item?.props as HeroBlockProps).cta?.paddingX || 0]}
						...
						<div className="flex flex-col mt-2 gap-2 w-full">
							...
							<Slider
								...
								max={20}
								step={1}
								value={[(item?.props as HeroBlockProps).cta?.paddingY || 0]}
								id="cta-padding-slider"
								onValueChange={(value) => {
									onPropsChange({
										id: item.id,
				...
				<div className="w-full flex gap-4 items-center justify-center">
					<div className="w-full">
						...
						<Slider
							...
							max={40}
							step={1}
							value={[(item?.props as HeroBlockProps).cta?.fontSize || 16]}
				...
				<div className="w-full flex gap-2 mb-2">
					...
					<div className="flex flex-col mt-2 gap-2 w-full">
						...
						<Slider
							...
							step={1}
							value={[
								(item?.props as HeroBlockProps).cta?.boxShadow?.shadowBlur || 0,
							]}
						...
						<FieldGroup>
							<Field orientation="horizontal">
								<Checkbox
									id="cta-bordered"
									name="cta-bordered"
									checked={(item?.props as HeroBlockProps).cta?.border || false}
